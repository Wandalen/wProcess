...
// now working at all, because fork spawns node executable by default
...
// passing arguments for executable( node ) throught execArgv
//https://nodejs.org/api/child_process.html#child_process_child_process_fork_modulepath_args_options

var o = { path : 'sample/Sample.js', mode : 'fork', execArgv : [ '--max_old_space_size=1024'  ] }
_.shell( o )
.doThen( () =>
{
