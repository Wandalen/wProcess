...
*/
  ...
  function run3()
  {
    ...
    runShell();
    else _.assert( 0, `Unknown mode ${_.strQuote( o.mode )} to start process at path ${_.strQuote( o.currentPath )}` ); /* qqq for Yevhen : problem with template-string is not complete! | aaa : Fixed. */
